...
export class Hud {
    constructor(game, x, y, width, height, images) {
        ...
        this.imageAkemi = new StaticImage(this.game, (this.width * 0.13), (this.height * 0.25), this.game.width * 0.34, this.game.height * 0.8, this.images[1], 0);
        ...
        this.buttonStart = new StaticImage(this.game, (this.width * 0.6), (this.height * 2.5), (this.width * 0.2), (this.game.height * 0.30), this.images[3], 1, "INICIAR", "bold", 7, 1.08, 1.16, "black");
