...
export class Scene8 {
    ...
    constructor(game) {
            ...
            (()=>{
                ...
                (()=>{
                    ...
                    if(this.choosedVegetable === 0){
                        ...
                        currentVegetableImage = this.tomate;
                        currentHeight = this.game.height * 0.12;
                        currentWidth = this.game.width * 0.08;
                    ...
                    if(this.choosedVegetable2 === 0){
                        ...
                        /**ABÓBORA */
                        currentVegetableImage2 = this.abobora;
                        ...
                        /**ALFACE */
                        currentVegetableImage2 = this.alface;
                        currentHeight2 = this.game.height * 0.12;
                        currentWidth2 = this.game.width * 0.08;
                        currentY2 = this.game.height * 0.75;
                        currentX2 = this.game.width * 0.38;
                        ...
                        /**BETERRABA*/
                        currentVegetableImage2 = this.beterraba;
                        ...
                        /**CENOURA */
                        currentVegetableImage2 = this.cenoura;
                        currentHeight2 = this.game.height * 0.15;
                        ...
                        currentVegetableImage2 = this.tomate;
                        currentHeight2 = this.game.height * 0.12;
                        currentWidth2 = this.game.width * 0.08;
                    ...
                    if(this.choosedVegetable3 === 0){
                        ...
                        /**ABÓBORA */
                        currentVegetableImage3 = this.abobora;
                        ...
                        /**ALFACE */
                        currentVegetableImage3 = this.alface;
                        currentHeight3 = this.game.height * 0.12;
                        ...
                        /**BETERRABA*/
                        currentVegetableImage3 = this.beterraba;
                        ...
                        /**CENOURA */
                        currentVegetableImage3 = this.cenoura;
                        currentHeight3 = this.game.height * 0.15;
                        ...
                        currentVegetableImage3 = this.tomate;
                        currentHeight3 = this.game.height * 0.12;
                        currentWidth3 = this.game.width * 0.08;
            ...
            (()=>{
                ...
                (()=>{
                    ...
                    (()=>{
                        ...
                        if(this.choosedVegetable === 0){
                            for(let i = 0; i < 5; i++){
                                this.createVegetable(this.abobora, this.fruitsLocations[i].x, this.fruitsLocations[i].y, ["FRUIT_1"]);
                            }
                        }

                        if(this.choosedVegetable === 1){
                            for(let i = 0; i < 5; i++){
                                this.createVegetable(this.alface, this.fruitsLocations[i].x, this.fruitsLocations[i].y, ["FRUIT_1"]);
                            }
                        }

                        if(this.choosedVegetable === 2){
                            for(let i = 0; i < 5; i++){
                                this.createVegetable(this.beterraba, this.fruitsLocations[i].x, this.fruitsLocations[i].y, ["FRUIT_1"]);
                            }
                        }

                        if(this.choosedVegetable === 3){
                            for(let i = 0; i < 5; i++){
                                this.createVegetable(this.cenoura, this.fruitsLocations[i].x, this.fruitsLocations[i].y, ["FRUIT_1"]);
                            }
                        }
                        ...
                        if(this.choosedVegetable2 === 0){
                            for(let i = 5; i < 10; i++){
                                this.createVegetable2(this.abobora, this.fruitsLocations[i].x, this.fruitsLocations[i].y, ["FRUIT_2"]);
                            }
                        }

                        if(this.choosedVegetable2 === 1){
                            for(let i = 5; i < 10; i++){
                                this.createVegetable2(this.alface, this.fruitsLocations[i].x, this.fruitsLocations[i].y, ["FRUIT_2"]);
                            }
                        }

                        if(this.choosedVegetable2 === 2){
                            for(let i = 5; i < 10; i++){
                                this.createVegetable2(this.beterraba, this.fruitsLocations[i].x, this.fruitsLocations[i].y, ["FRUIT_2"]);
                            }
                        }

                        if(this.choosedVegetable2 === 3){
                            for(let i = 5; i < 10; i++){
                                this.createVegetable2(this.cenoura, this.fruitsLocations[i].x, this.fruitsLocations[i].y, ["FRUIT_2"]);
                            }
                        }
                        ...
                        if(this.choosedVegetable3 === 0){
                            for(let i = 10; i < 15; i++){
                                this.createVegetable3(this.abobora, this.fruitsLocations[i].x, this.fruitsLocations[i].y, ["FRUIT_3"]);
                            }
                        }

                        if(this.choosedVegetable3 === 1){
                            for(let i = 10; i < 15; i++){
                                this.createVegetable3(this.alface, this.fruitsLocations[i].x, this.fruitsLocations[i].y, ["FRUIT_3"]);
                            }
                        }

                        if(this.choosedVegetable3 === 2){
                            for(let i = 10; i < 15; i++){
                                this.createVegetable3(this.beterraba, this.fruitsLocations[i].x, this.fruitsLocations[i].y, ["FRUIT_3"]);
                            }
                        }

                        if(this.choosedVegetable3 === 3){
                            for(let i = 10; i < 15; i++){
                                this.createVegetable3(this.cenoura, this.fruitsLocations[i].x, this.fruitsLocations[i].y, ["FRUIT_3"]);
                            }
                        }
        ...
        setInterval(() => {
            ...
            console.log("Toupeira Punched: " + this.toupeiraPunched);
    ...
    update(deltaTime) {
            ...
            (()=>{
               ...
               for(let i = 0; i < this.toupeiras.length; i++){
                ...
                if(this.fruits[this.currentTarget]){
                    ...
                    if(!this.fruits2[this.currentTarget - 5].collidesWith(this.basket && !this.toupeiraPunched)){
                        ...
                        if(this.toupeiras[i].collidesWith(this.fruits2[this.currentTarget - 5])){
                            this.fruits2[this.currentTarget - 5].draggedRight = true;
                            if(!this.toupeiraPunched){
                                this.fruits2[this.currentTarget - 5].moveTo(this.toupeiras[i].x + 50, this.toupeiras[i].y + 145, 3.5);
                            }
                            setTimeout(() => {
                                this.justGrabbed = true;
                            }, 2500);
                    ...
                    if(!this.fruits3[this.currentTarget - 10].collidesWith(this.basket && !this.toupeiraPunched)){
                        ...
                        if(this.toupeiras[i].collidesWith(this.fruits3[this.currentTarget - 10])){
                            this.fruits3[this.currentTarget - 10].draggedRight = true;
                            if(!this.toupeiraPunched){
                                this.fruits3[this.currentTarget - 10].moveTo(this.toupeiras[i].x + 50, this.toupeiras[i].y + 145, 3.5);
                            }
                            setTimeout(() => {
                                this.justGrabbed = true;
                            }, 2500);
        ...
        (()=>{
            ...
            for(let i = 0; i < this.fruits2.length; i++){
                if(this.toupeiras[0]){
                    if(this.fruits2[i].draggedRight && !this.toupeiras[0].collidesWith(this.fruits2[i]) && !this.fruits2[i].collidesWith(this.basket) && this.fruits2[i].y < this.game.height){
            ...
            for(let i = 0; i < this.fruits3.length; i++){
                if(this.toupeiras[0]){
                    if(this.fruits3[i].draggedRight && !this.toupeiras[0].collidesWith(this.fruits3[i]) && !this.fruits3[i].collidesWith(this.basket) && this.fruits3[i].y < this.game.height){
                ...
                for(let i = 0; i < this.toupeiras.length; i++){
                    if(this.toupeiras[i].isMouseClicking() && !this.game.isDraggingImage || this.toupeiras[i].isTouchOver() && !this.game.isDraggingImage){
                        ...
                        for(let l = 0; l < this.fruits3.length; l++){
                            if(this.fruits3[l]){
                                if(this.fruits3[l].collidesWith(this.toupeiras[i])){
                        ...
                        if(this.currentTarget > 4 && this.currentTarget < 9){ {
                            for(let j = 0; j < this.fruits2.length; j++){
                                if(this.fruits2[j]){
                                    if(this.fruits2[j].collidesWith(this.toupeiras[i])){
                                        if(this.fruits2[this.currentTarget - 5]){
                                            this.fruits2[this.currentTarget - 5].draggedRight = false;
                                        }
                                        this.protectFruit = true;
                        ...
                        if(this.currentTarget > 9){ {
                            for(let j = 0; j < this.fruits3.length; j++){
                                if(this.fruits3[j]){
                                    if(this.fruits3[j].collidesWith(this.toupeiras[i])){
                                        if(this.fruits3[this.currentTarget - 10]){
    ...
    draw(ctx, scene) {
        ...
        (()=>{
            ...
            //CONTINUAR AQUI, DESENHAR A TOUPEIRA NO LAYER CORRETO, QUANDO NO CURRENTARGET QUE É
