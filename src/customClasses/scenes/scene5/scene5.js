...
export class Scene5 {
    ...
    constructor(game) {
        ...
        (()=>{
            ...
            /**MUST BE DIFFERENT FROM randomFruit */
            this.randomFruit2 = Math.floor(Math.random() * 6);  
            this.randomFruit3 = Math.floor(Math.random() * 6);
            while(this.randomFruit2 === this.randomFruit || this.randomFruit2 === this.randomFruit3){
                this.randomFruit2 = Math.floor(Math.random() * 6);
                this.randomFruit3 = Math.floor(Math.random() * 6);
            };
            ...
            (()=>{
                ...
                this.fruitsLocations = [
                    {x: this.game.width * 0.05, y: this.game.height * 0.32},
                    {x: this.game.width * 0.15, y: this.game.height * 0.18},
                    {x: this.game.width * 0.08, y: this.game.height * 0.2},
                    {x: this.game.width * 0.09, y: this.game.height * 0.39},
                    {x: this.game.width * 0.14, y: this.game.height * 0.31},


                    /**SAME LOCATIONS THAN 2 */
                    {x: this.game.width * 0.315, y: this.game.height * 0.12},
                    {x: this.game.width * 0.37, y: this.game.height * 0.16},
                    {x: this.game.width * 0.25, y: this.game.height * 0.2},
                    {x: this.game.width * 0.27, y: this.game.height * 0.31},
                    {x: this.game.width * 0.36, y: this.game.height * 0.28},


                    /**SAME LOCATIONS THAN 3 */
                    {x: this.game.width * 0.49, y: this.game.height * 0.31},
                ...
                this.fruitsToDrag = Math.floor(Math.random() * 4) + 1;
                this.fruitsToDrag2 = Math.floor(Math.random() * 4) + 1;
                this.fruitsToDrag3 = Math.floor(Math.random() * 4) + 1;

                
                while(this.fruitsToDrag === this.fruitsToDrag2 ||
                      this.fruitsToDrag2 === this.fruitsToDrag3 || 
                      this.fruitsToDrag === this.fruitsToDrag3 ||
                      (this.fruitsToDrag + this.fruitsToDrag2 + this.fruitsToDrag3) > 9){
                    this.fruitsToDrag = Math.floor(Math.random() * 4) + 1;
                    this.fruitsToDrag2 = Math.floor(Math.random() * 4) + 1;
                    this.fruitsToDrag3 = Math.floor(Math.random() * 4) + 1;
                };
                ...
                this.choosedFruit = Math.floor(Math.random() * 4);
                this.choosedFruit2 = Math.floor(Math.random() * 4);
                this.choosedFruit3 = Math.floor(Math.random() * 4);

                while(this.choosedFruit === this.choosedFruit2 || 
                      this.choosedFruit2 === this.choosedFruit3 ||
                      this.choosedFruit === this.choosedFruit3){
                    this.choosedFruit2 = Math.floor(Math.random() * 4);
                    this.choosedFruit3 = Math.floor(Math.random() * 4);
                };
        ...
        (()=>{
            ...
            this.mediumTree0 = document.getElementById('mediumTree');
            this.hardTree0 = document.getElementById('hardTree');
            /**PRODUCTS QTY */
        ...
        (()=>{
            ...
            (()=>{
                ...
                (()=>{
                    ...
                    this.fruitIndicator = new Image(
                        this.game, /**GAME */
                        (this.game.width * 0.045), /**X */
                        (this.height * 0.71), /**Y */
                        (this.game.width * 0.64), /**WIDTH */
                        ...
                        (this.game.width * 0.065), /**TEXT X */
                        (this.height * 1.50), /**TEXT Y */
                        "black", /**TEXT COLOR */
                        true, /**MOUSE HOVER */
                        null, /**TEXTS ALIGN -> ROW OR COLUMN */
                        ``, /**UNIQUE TEXT */
                        (this.game.width * 0.085), // UNIQUE TEXT X
                        (this.game.height * 0.80), // UNIQUE TEXT Y
                    ...
                    let currentFruitImage2 = null;
                    let currentFruitImage3 = null;
                    ...
                    if(this.choosedFruit2 === 0){
                        currentFruitImage2 = this.appleImage;
                    } else if (this.choosedFruit2 === 1){
                        currentFruitImage2 = this.pera;
                    } else if (this.choosedFruit2 === 2){
                        currentFruitImage2 = this.manga;
                    } else if (this.choosedFruit2 === 3){
                        currentFruitImage2 = this.laranja;
                    } else if (this.choosedFruit2 === 4){
                        currentFruitImage2 = this.limao;
                    } else if (this.choosedFruit2 === 5){
                        currentFruitImage2 = this.caju;
                    }

                    if(this.choosedFruit3 === 0){
                        currentFruitImage3 = this.appleImage;
                    } else if (this.choosedFruit3 === 1){
                        currentFruitImage3 = this.pera;
                    } else if (this.choosedFruit3 === 2){
                        currentFruitImage3 = this.manga;
                    } else if (this.choosedFruit3 === 3){
                        currentFruitImage3 = this.laranja;
                    } else if (this.choosedFruit3 === 4){
                        currentFruitImage3 = this.limao;
                    } else if (this.choosedFruit3 === 5){
                        currentFruitImage3 = this.caju;
                    }

                    this.fruitToCatch = new Image(
                        this.game, /**GAME */
                        (this.game.width * 0.15), /**X */
                        (this.height * 0.78), /**Y */
                    ...
                    this.fruitToCatch2 = new Image(
                        this.game, /**GAME */
                        (this.game.width * 0.355), /**X */
                        (this.height * 0.78), /**Y */
                        (this.game.width * 0.05), // WIDTH
                        (this.game.height * 0.1), // HEIGHT
                        0, /**ROTATION */
                        currentFruitImage2,  /**IMAGE */
                        1, /**OPACITY */
                        null, /**TEXT */
                        (this.height * 0.1), /**TEXT SPACING */
                        "PatrickHand", /**TEXT FONT */
                        ...
                        (this.game.width * 0.286), // UNIQUE TEXT X
                        (this.game.height * 0.805), // UNIQUE TEXT Y
                        false, // CURSOR VISIBLE (added to match constructor parameters)
                        0, // TEXT OFFSET X (added to match constructor parameters)
                        0, // TEXT OFFSET Y (added to match constructor parameters)
                    ...
                    this.fruitToCatch3 = new Image(
                        this.game, /**GAME */
                        (this.game.width * 0.56), /**X */
                        (this.height * 0.78), /**Y */
                        (this.game.width * 0.05), // WIDTH
                        (this.game.height * 0.1), // HEIGHT
                        0, /**ROTATION */
                        currentFruitImage3,  /**IMAGE */
                        1, /**OPACITY */
                        null, /**TEXT */
                        (this.height * 0.1), /**TEXT SPACING */
                        "PatrickHand", /**TEXT FONT */
            ...
            (()=>{
                ...
                (()=>{
                    ...
                    this.mediumTree = new Image(
                        this.game, /**GAME */
                        (this.game.width * 0.24), /**X */
                        (this.height * 0.1), /**Y */
                        (this.game.width * 0.2), /**WIDTH */
                        (this.game.height * 0.55), /**HEIGHT */
                        0, /**ROTATION */
                        this.mediumTree0,  /**IMAGE */
                        1, /**OPACITY */
                        null, /**TEXT */
                        (this.height * 0.1), /**TEXT SPACING */
                        "font1942", /**TEXT FONT */
                    ...
                    this.hardTree = new Image(
                        this.game, /**GAME */
                        (this.game.width * 0.47), /**X */
                        (this.height * 0.15), /**Y */
                        (this.game.width * 0.20), /**WIDTH */
                        (this.game.height * 0.5), /**HEIGHT */
                        0, /**ROTATION */
                        this.hardTree0,  /**IMAGE */
                        1, /**OPACITY */
                        null, /**TEXT */
                        (this.height * 0.1), /**TEXT SPACING */
                        "font1942", /**TEXT FONT */
                ...
                (()=>{
                    ...
                    (()=>{
                        ...
                        (()=>{
                            if(this.choosedFruit3 === 0){
                                for(let i = 0; i < 5; i++){
                                    this.createFruit(this.appleImage, this.fruitsLocations3[i].x, this.fruitsLocations3[i].y, ["FRUIT_3"]);
                                }
                            }
    
                            if(this.choosedFruit3 === 1){
                                for(let i = 0; i < 5; i++){
                                    this.createFruit(this.pera, this.fruitsLocations3[i].x, this.fruitsLocations3[i].y, ["FRUIT_3"]);
                                }
                            }
    
                            if(this.choosedFruit3 === 2){
                                for(let i = 0; i < 5; i++){
                                    this.createFruit(this.manga, this.fruitsLocations3[i].x, this.fruitsLocations3[i].y, ["FRUIT_3"]);
                                }
                            }
    
                            if(this.choosedFruit3 === 3){
                                for(let i = 0; i < 5; i++){
                                    this.createFruit(this.laranja, this.fruitsLocations3[i].x, this.fruitsLocations3[i].y, ["FRUIT_3"]);
                                }
                            }
    
                            if(this.choosedFruit3 === 4){
                                for(let i = 0; i < 5; i++){
                                    this.createFruit(this.limao, this.fruitsLocations3[i].x, this.fruitsLocations3[i].y, ["FRUIT_3"]);
                                }
                            }
    
                            if(this.choosedFruit3 === 5){
                                for(let i = 0; i < 5; i++){
                                    this.createFruit(this.caju, this.fruitsLocations3[i].x, this.fruitsLocations3[i].y, ["FRUIT_3"]);
                                }
                            }
                        })();
    ...
    update(deltaTime) {
        ...
        (()=>{
            ...
            for(let i = 0; i < this.fruits.length; i++){
                ...
                this.fruits3Stolen = this.stolenFruits.filter(fruit => fruit.tags.includes("FRUIT_3"));
    
                this.stoleLimit = ((this.fruits.length / 3) - this.fruitsToDrag) - this.fruits1Stolen.length;
                this.stoleLimit2 = ((this.fruits.length / 3) - this.fruitsToDrag2) - this.fruits2Stolen.length;
                this.stoleLimit3 = ((this.fruits.length / 3) - this.fruitsToDrag3) - this.fruits3Stolen.length;
                ...
                if(this.stoleLimit === -1 || this.stoleLimit2 === -1 || this.stoleLimit3 === -1){
                ...
                for(let i = 0; i < this.birds.length; i++){
                    if(this.birds[i].isMouseClicking() && !this.game.isDraggingImage || this.birds[i].isTouchOver() && !this.game.isDraggingImage){
                        ...
                        for(let j = 0; j < this.fruits.length; j++){
                            if(this.fruits[j]){
                                if(this.fruits[j].collidesWith(this.birds[i]) && this.fruits[this.currentTarget]){
    ...
    draw(ctx, scene) {
        ...
        (()=>{
            ...
            this.mediumTree.draw(ctx, 0);
            this.hardTree.draw(ctx, 0);
