...
export class scene11 {
    ...
    constructor(game) {
        ...
        (()=>{
            ...
            this.randomFruit2 = Math.floor(Math.random() * 6);
            this.randomFruit3 = Math.floor(Math.random() * 6);

            while(this.randomFruit === this.randomFruit2 || this.randomFruit === this.randomFruit3 || this.randomFruit2 === this.randomFruit3){
                this.randomFruit = Math.floor(Math.random() * 6);
                this.randomFruit2 = Math.floor(Math.random() * 6);
                this.randomFruit3 = Math.floor(Math.random() * 6);
            }
            ...
            (()=>{
                ...
                this.fruitsLocations = [
                    {x: this.game.width * 0.00, y: this.game.height * 0.25},
                    {x: this.game.width * 0.10, y: this.game.height * 0.25},
                    {x: this.game.width * 0.20, y: this.game.height * 0.25},
                    {x: this.game.width * 0.30, y: this.game.height * 0.25},
                    {x: this.game.width * 0.40, y: this.game.height * 0.25},

                    {x: this.game.width * 0.10, y: this.game.height * 0.34},
                    {x: this.game.width * 0.20, y: this.game.height * 0.34},
                    {x: this.game.width * 0.30, y: this.game.height * 0.34},
                    {x: this.game.width * 0.40, y: this.game.height * 0.34},
                    {x: this.game.width * 0.50, y: this.game.height * 0.34},
                ...
                this.fruitsToDrag = 0;
                this.fruitsToDrag2 = 0;
                this.fruitsToDrag3 = 0;
                this.choosedVegetable = 0;
                this.choosedVegetable2 = 0;
                this.choosedVegetable3 = 0;
                this.fruitsInBasket = [];

                /**RANDOM NUMBER BETWEEN 1 AND 9 */
                this.fruitsToDrag = Math.floor(Math.random() * 3) + 1;
                this.fruitsToDrag2 = Math.floor(Math.random() * 3) + 1;
                this.fruitsToDrag3 = Math.floor(Math.random() * 3) + 1;

                while(this.fruitsToDrag >= 4 || this.fruitsToDrag2 >= 4 || this.fruitsToDrag3 >= 4){
                    this.fruitsToDrag = Math.floor(Math.random() * 5) + 1;
                    this.fruitsToDrag2 = Math.floor(Math.random() * 5) + 1;
                    this.fruitsToDrag3 = Math.floor(Math.random() * 5) + 1;
                }

                /**RANDOM NUMBER BETWEEN 0 AND 5 */
                this.choosedVegetable = Math.floor(Math.random() * 4);
                this.choosedVegetable2 = Math.floor(Math.random() * 4);
                this.choosedVegetable3 = Math.floor(Math.random() * 4);



                while(this.choosedVegetable === 4 || this.choosedVegetable === 5 ||
                     this.choosedVegetable === this.choosedVegetable2 ||
                     this.choosedVegetable2 === 4 || this.choosedVegetable2 === 5  ||
                     this.choosedVegetable2 === this.choosedVegetable3 ||
                     this.choosedVegetable3 === 4 || this.choosedVegetable3 === 5  ||
                     this.choosedVegetable3 === this.choosedVegetable){
                    this.choosedVegetable = Math.floor(Math.random() * 5);
                    this.choosedVegetable2 = Math.floor(Math.random() * 5);
                    this.choosedVegetable3 = Math.floor(Math.random() * 5);
                }
        ...
        (()=>{
            ...
            /**FENCE */
            this.fence0 = document.getElementById('fence_bigger');
            /**GROUNDS */
            ...
            /**ENEMY -> lagarta */
            this.lagartaImage = document.getElementById('lagarta');
            /**LADYBIRD */
            ...
            (()=>{
                ...
                /**VEGETABLES */
                this.flor1 = document.getElementById('flor1');
                this.flor2 = document.getElementById('flor2');
                this.flor3 = document.getElementById('flor3');
                this.flor4 = document.getElementById('flor4');
                this.flor5 = document.getElementById('flor5');
            ...
            (()=>{
                ...
                (()=>{
                    ...
                    this.fruitIndicator = new Image(
                        ...
                        (this.game.width * 0.135), // UNIQUE TEXT X
                        (this.game.height * 0.79), // UNIQUE TEXT Y
                    ...
                    let currentVegetableImage2 = null;
                    let currentVegetableImage3 = null;
                    let currentWidth = null;
                    let currentWidth2 = null;
                    let currentWidth3 = null;
                    let currentHeight = null;
                    let currentHeight2 = null;
                    let currentHeight3 = null;
                    let currentY = null;
                    let currentY2 = null;
                    let currentY3 = null;
                    let currentX = null;
                    ...
                    if(this.choosedVegetable === 0){
                        ...
                        /**ABÓBORA */
                        currentVegetableImage = this.flor1;
                        currentHeight = this.game.height * 0.12;
                        currentWidth = this.game.width * 0.08;
                        currentY = this.game.height * 0.75;
                        currentX = this.game.width * 0.18;

                    } else if (this.choosedVegetable === 1){

                        /**flor2 */
                        currentVegetableImage = this.flor2;
                        currentHeight = this.game.height * 0.12;
                        currentWidth = this.game.width * 0.08;
                        currentY = this.game.height * 0.75;
                        currentX = this.game.width * 0.18;
                        ...
                        /**flor3*/
                        currentVegetableImage = this.flor3;
                        currentHeight = this.game.height * 0.15;
                        currentWidth = this.game.width * 0.035;
                        currentY = this.game.height * 0.725;
                        currentX = this.game.width * 0.2;

                    } else if (this.choosedVegetable === 3){

                        /**flor4 */
                        currentVegetableImage = this.flor4;
                        currentHeight = this.game.height * 0.15;
                        currentWidth = this.game.width * 0.05;
                        currentY = this.game.height * 0.73;
                        currentX = this.game.width * 0.2;
                    ...
                    if(this.choosedVegetable2 === 0){
                        ...
                        /**ABÓBORA */
                        currentVegetableImage2 = this.flor1;
                        currentHeight2 = this.game.height * 0.12;
                        currentWidth2 = this.game.width * 0.08;
                        currentY2 = this.game.height * 0.75;
                        currentX2 = this.game.width * 0.38;

                    } else if (this.choosedVegetable2 === 1){

                        /**flor2 */
                        currentVegetableImage2 = this.flor2;
                        currentHeight2 = this.game.height * 0.12;
                        currentWidth2 = this.game.width * 0.08;
                        currentY2 = this.game.height * 0.75;
                        currentX2 = this.game.width * 0.38;

                    } else if (this.choosedVegetable2 === 2){

                        /**flor3*/
                        currentVegetableImage2 = this.flor3;
                        currentHeight2 = this.game.height * 0.15;
                        currentWidth2 = this.game.width * 0.035;
                        currentY2 = this.game.height * 0.72;
                        currentX2 = this.game.width * 0.385;

                    } else if (this.choosedVegetable2 === 3){

                        /**flor4 */
                        currentVegetableImage2 = this.flor4;
                        currentHeight2 = this.game.height * 0.15;
                        currentWidth2 = this.game.width * 0.05;
                        currentY2 = this.game.height * 0.73;
                        currentX2 = this.game.width * 0.38;

                    } else if (this.choosedVegetable2 === 4){

                        currentVegetableImage2 = this.flor4;
                        currentHeight2 = this.game.height * 0.12;
                        currentWidth2 = this.game.width * 0.08;
                        currentY2 = this.game.height * 0.78;
                        currentX2 = this.game.width * 0.38;

                    } else if (this.choosedVegetable2 === 5){
                        ...
                        currentWidth2 = this.game.width * 0.08;
                        currentY2 = this.game.height * 0.78;
                        currentX2 = this.game.width * 0.37;

                    }

                    if(this.choosedVegetable3 === 0){
                        console.log("to aqui otário")

                        /**ABÓBORA */
                        currentVegetableImage3 = this.flor1;
                        currentHeight3 = this.game.height * 0.12;
                        currentWidth3 = this.game.width * 0.09;
                        currentY3 = this.game.height * 0.75;
                        currentX3 = this.game.width * 0.57;
                    } else if (this.choosedVegetable3 === 1){

                        /**flor2 */
                        currentVegetableImage3 = this.flor2;
                        currentHeight3 = this.game.height * 0.12;
                        currentWidth3 = this.game.width * 0.08;
                        currentY3 = this.game.height * 0.75;
                        currentX3 = this.game.width * 0.57;

                    } else if (this.choosedVegetable3 === 2){

                        /**flor3*/
                        currentVegetableImage3 = this.flor3;
                        currentHeight3 = this.game.height * 0.15;
                        currentWidth3 = this.game.width * 0.035;
                        currentY3 = this.game.height * 0.72;
                        currentX3 = this.game.width * 0.58;
                    } else if (this.choosedVegetable3 === 3){

                        /**flor4 */
                        currentVegetableImage3 = this.flor4;
                        currentHeight3 = this.game.height * 0.15;
                        currentWidth3 = this.game.width * 0.05;
                        currentY3 = this.game.height * 0.73;
                        currentX3 = this.game.width * 0.58;
                    } else if (this.choosedVegetable3 === 4){

                        currentVegetableImage3 = this.flor4;
                        currentHeight3 = this.game.height * 0.12;
                        currentWidth3 = this.game.width * 0.08;
                        currentY3 = this.game.height * 0.78;
                        currentX3 = this.game.width * 0.58;
                    } else if (this.choosedVegetable3 === 5){
                    ...
                    this.fruitToCatch2 = new Image(
                        ...
                        (this.game.width * 0.325), // UNIQUE TEXT X
                        (this.game.height * 0.785), // UNIQUE TEXT Y
                        false, // CURSOR VISIBLE (added to match constructor parameters)
                        0, // TEXT OFFSET X (added to match constructor parameters)
                        0, // TEXT OFFSET Y (added to match constructor parameters)
                        true // HOVER SCALE (added to match constructor parameters)
                    ...
                    this.fruitToCatch3 = new Image(
                        this.game, /**GAME */
                        currentX3, /**X */
                        currentY3, /**Y */
                        currentWidth3, // WIDTH
                        currentHeight3, // HEIGHT
                        0, /**ROTATION */
                        currentVegetableImage3,  /**IMAGE */
                        1, /**OPACITY */
                        null, /**TEXT */
                        (this.height * 0.1), /**TEXT SPACING */
                        "PatrickHand", /**TEXT FONT */
                        ...
                        true, /**MOUSE HOVER */
                        null, /**TEXTS ALIGN -> ROW OR COLUMN */
                        `${this.fruitsToDrag3}`, /**UNIQUE TEXT */
                        (this.game.width * 0.515), // UNIQUE TEXT X
                        (this.game.height * 0.785), // UNIQUE TEXT Y
                        false, // CURSOR VISIBLE (added to match constructor parameters)
                        0, // TEXT OFFSET X (added to match constructor parameters)
                        0, // TEXT OFFSET Y (added to match constructor parameters)
                    ...
                    (()=>{
                        ...
                        if(this.choosedVegetable === 4 || this.choosedVegetable === 5){
                            ...
                            for(let i = 0; i < tomateiros.length; i++){
                                ...
                                if(i !== -1){
                                    const currentTomato = this.createVegetable(this.flor4, tomateiros[i].x + 30, tomateiros[i].y + 100);
                                    currentTomato.tags.push(`TOMATEIRO${i}`);
                                    const currentTomato2 = this.createVegetable(this.flor4, tomateiros[i].x + 120, tomateiros[i].y + 100);
                                    currentTomato2.tags.push(`TOMATEIRO${i}`);
                                    const currentTomato3 = this.createVegetable(this.flor4, tomateiros[i].x + 160, tomateiros[i].y + 20);
        ...
        (()=>{
            ...
            (()=>{
                ...
                setInterval(() => {
                    if(this.lagartas.length === 0 && this.startGame){
                        let currentlagarta = new Sprite(
                            [
                                this.lagartaImage, /** FLYING */
                            ], /** IMAGE */
                            this.game, /** GAME */
                            87.25, /** SPRITE WIDTH */
                            216, /** SPRITE HEIGHT */
                        ...
                        this.lagartas.push(currentlagarta);
                    }
                }, 2000);
            ...
            (()=>{
                ...
                this.currentTarget = Math.floor(Math.random() * (this.fruits.length + this.fruits2.length + this.fruits3.length));
            })();
        ...
        setInterval(() => {
            ...
            console.log("lagarta Punched: " + this.lagartaPunched);
    ...
    update(deltaTime) {
        ...
        (()=>{
            ...
            (()=>{
                ...
                if(this.currentTarget > 4 && this.currentTarget <= 9){
                    if(this.fruits2[this.currentTarget - 5]){
                        if(this.fruits2[this.currentTarget - 5].isGrabbed ||
                            this.fruits2[this.currentTarget - 5].collidesWith(this.basket) ||
                            this.fruits2[this.currentTarget - 5].y > (this.game.height * 0.9) + this.fruits2[this.currentTarget - 5].height ){
                                this.currentTarget = Math.floor(Math.random() * (this.fruits.length + this.fruits2.length));
                         }
                    }
                }

                if(this.currentTarget > 9 && this.currentTarget <= 14){
                    if(this.fruits3[this.currentTarget - 10]){
                        if(this.fruits3[this.currentTarget - 10].isGrabbed ||
                            this.fruits3[this.currentTarget - 10].collidesWith(this.basket) ||
                            this.fruits3[this.currentTarget - 10].y > (this.game.height * 0.9) + this.fruits3[this.currentTarget - 10].height ){
                                this.currentTarget = Math.floor(Math.random() * (this.fruits.length + this.fruits2.length + this.fruits3.length));
                         }
                    }
                }
               ...
               for(let i = 0; i < this.lagartas.length; i++){
                    ...
                    if(this.fruits2[this.currentTarget - 5]){
                        if(this.fruits2[this.currentTarget - 5].y > this.game.height * 1 ||
                            this.fruits2[this.currentTarget - 5].tags.includes("TOMATO") ||
                            (this.fruits2[this.currentTarget - 5].tags.includes("TOMATEIRO") && this.currentTarget === 15)
                        ){
                            this.currentTarget = Math.floor(Math.random() * (this.fruits.length + this.fruits2.length + this.fruits3.length));
                        };
                    };
                    ...
                    if(this.fruits3[this.currentTarget - 10]){
                        if(this.fruits3[this.currentTarget - 10].y > this.game.height * 1 ||
                            this.fruits3[this.currentTarget - 10].tags.includes("TOMATO") ||
                            (this.fruits3[this.currentTarget - 10].tags.includes("TOMATEIRO") && this.currentTarget === 15)
                        ){
                            this.currentTarget = Math.floor(Math.random() * (this.fruits.length + this.fruits2.length + this.fruits3.length));
                        };
                    };
                ...
                if(this.fruits[this.currentTarget]){
                    ...
                    if(!this.fruits[this.currentTarget].collidesWith(this.basket) && !this.lagartaPunched){                        
                        ...
                        if(!this.justGrabbed && this.fruits[this.currentTarget].y < this.game.height * 0.9){
                            ...
                            if(this.fruits[this.currentTarget].tags.includes("TOMATEIRO")){
                                this.lagartas[i].moveTo(this.tomatoesLocations[this.currentTarget].x, this.tomatoesLocations[this.currentTarget].y - 175, 5);
                            } else {
                                if(!this.lagartaPunched){
                                    this.lagartas[i].moveTo(this.fruitsLocations[this.currentTarget].x, this.fruitsLocations[this.currentTarget].y - 175, 5);
                                } else {
                                    this.lagartas[i].moveTo(this.fruitsLocations[this.currentTarget].x, this.height * 1.2, 5);
                                }
                            }
                            ...
                            if(!this.lagartaPunched){
                                this.lagartas[i].moveTo(this.fruitsLocations[this.currentTarget].x, this.game.height * 1.16, 3);
                            } else {
                                this.lagartas[i].moveTo(this.fruitsLocations[this.currentTarget].x, this.height * 1.2, 5);
                            }
                        }
    
                        if(this.lagartas[i].collidesWith(this.fruits[this.currentTarget])){
                            this.fruits[this.currentTarget].draggedRight = true;
                            if(!this.lagartaPunched){
                                this.fruits[this.currentTarget].moveTo(this.lagartas[i].x + 50, this.lagartas[i].y + 145, 3.5);
                            }
                            setTimeout(() => {
                        ...
                        /**IF THE MOLE GO AWAY FROM CANVAS, IT WILL BE DELETED */
                        if(this.lagartas[i].y > this.game.height * 1.06){
                            this.lagartas.splice(i, 1);
                            this.currentTarget = Math.floor(Math.random() * (this.fruits.length + this.fruits2.length));
                            if(this.fruits2[this.currentTarget - 5]){
                                while(this.fruits2[this.currentTarget - 5]?.y > this.game.height * 0.9)
                                {
                                    this.currentTarget = Math.floor(Math.random() * (this.fruits.length + this.fruits2.length));
                                };
                            } 
                        ...
                        this.lagartas[i].moveTo(this.game.width * -0.5, this.game.height * 1.2 - 125, 10);
                    }

                } else if (this.fruits2[this.currentTarget - 5]){

                    if(!this.fruits2[this.currentTarget - 5].collidesWith(this.basket && !this.lagartaPunched)){

                        if(!this.justGrabbed && this.fruits2[this.currentTarget -5].y < this.game.height * 0.9){
                            
                            if(this.fruits2[this.currentTarget - 5].tags.includes("TOMATEIRO")){
                                this.lagartas[i].moveTo(this.tomatoesLocations[this.currentTarget].x, this.tomatoesLocations[this.currentTarget].y - 175, 5);
                            } else {
                                if(!this.lagartaPunched) {
                                this.lagartas[i].moveTo(this.fruitsLocations[this.currentTarget].x, this.fruitsLocations[this.currentTarget].y - 175, 5);
                        ...
                        if(this.lagartas[i].collidesWith(this.fruits2[this.currentTarget - 5])){
                            this.fruits2[this.currentTarget - 5].draggedRight = true;
                            if(!this.lagartaPunched){
                                this.fruits2[this.currentTarget - 5].moveTo(this.lagartas[i].x + 50, this.lagartas[i].y + 145, 3.5);
                            }
                            setTimeout(() => {
                                this.justGrabbed = true;
                            }, 2500);
                ...
                } else if (this.fruits3[this.currentTarget - 10]){

                    if(!this.fruits3[this.currentTarget - 10].collidesWith(this.basket && !this.lagartaPunched)){

                        if(!this.justGrabbed && this.fruits3[this.currentTarget -10].y < this.game.height * 0.9){
                            
                            if(this.fruits3[this.currentTarget - 10].tags.includes("TOMATEIRO")){
                                this.lagartas[i].moveTo(this.tomatoesLocations[this.currentTarget].x, this.tomatoesLocations[this.currentTarget].y - 175, 5);
                            } else {
                                if(!this.lagartaPunched){
                                this.lagartas[i].moveTo(this.fruitsLocations[this.currentTarget].x, this.fruitsLocations[this.currentTarget].y - 175, 5);
                        ...
                        if(this.lagartas[i].collidesWith(this.fruits3[this.currentTarget - 10])){
                            this.fruits3[this.currentTarget - 10].draggedRight = true;
                            if(!this.lagartaPunched){
                                this.fruits3[this.currentTarget - 10].moveTo(this.lagartas[i].x + 50, this.lagartas[i].y + 145, 3.5);
                            }
                            setTimeout(() => {
                                this.justGrabbed = true;
                            }, 2500);
                        ...
                        if(this.lagartas[i].y > this.game.height * 1.06){
                            ...
                            this.currentTarget = Math.floor(Math.random() * (this.fruits.length + this.fruits2.length));
                            if(this.fruits3[this.currentTarget - 10]){
                                while(this.fruits3[this.currentTarget - 10]?.y > this.game.height * 0.9)
                                {
                                    this.currentTarget = Math.floor(Math.random() * (this.fruits.length + this.fruits2.length));
                                };
                            } 
        ...
        (()=>{
            ...
            for(let i = 0; i < this.fruits.length; i++){
                if(this.lagartas[0]){
                    if(this.fruits[i].draggedRight && !this.lagartas[0].collidesWith(this.fruits[i]) && !this.fruits[i].collidesWith(this.basket) && this.fruits[i].y < this.game.height){
            ...
            for(let i = 0; i < this.fruits2.length; i++){
                if(this.lagartas[0]){
                    if(this.fruits2[i].draggedRight && !this.lagartas[0].collidesWith(this.fruits2[i]) && !this.fruits2[i].collidesWith(this.basket) && this.fruits2[i].y < this.game.height){
                        this.fruits2[i].draggedRight = false;
                    }
                }
            }
            ...
            for(let i = 0; i < this.fruits3.length; i++){
                if(this.lagartas[0]){
                    if(this.fruits3[i].draggedRight && !this.lagartas[0].collidesWith(this.fruits3[i]) && !this.fruits3[i].collidesWith(this.basket) && this.fruits3[i].y < this.game.height){
                        this.fruits3[i].draggedRight = false;
                    }
                }
            }
        ...
        (()=>{
            ...
            this.stoleLimit3 = (this.fruits3.length - this.fruitsToDrag3) - this.stolenFruits3.length;
            ...
            /**FRUIT 3 HANDLER */
            for(let i = 0; i < this.fruits3.length; i++){
                if(this.fruits3[i].y > this.game.height * 0.95) {
                    
                    if(!this.stolenFruits3.includes(this.fruits3[i])){
                        this.stolenFruits3.push(this.fruits3[i]);
                ...
                if(!this.startGame){
                    ...
                    if(this.correctAnswer){
                        ...
                        if(this.enterNextScene){
                            this.lagartas.splice(0, this.lagartas.length);
                            ...
                            for(let i = 0; i < this.fruits2.length; i++){
                                this.fruits2[i].fadeOut(0.05);
                            }
                            for(let i = 0; i < this.fruits3.length; i++){
                                this.fruits3[i].fadeOut(0.05);
                            }
        ...
        (() => {
            ...
            (()=>{
                for(let i = 0; i < this.lagartas.length; i++){
                    if(this.lagartas[i].isMouseClicking() && !this.game.isDraggingImage || this.lagartas[i].isTouchOver() && !this.game.isDraggingImage){

                        this.lagartaPunched = true;
                        setTimeout(() => {
                            this.lagartaPunched = false;
                        }, 5000);
                        ...
                        for(let j = 0; j < this.fruits.length; j++){
                            if(this.fruits[j]){
                                if(this.fruits[j].collidesWith(this.lagartas[i])){
                                    if(this.fruits[this.currentTarget]){
                        ...
                        for(let k = 0; k < this.fruits2.length; k++){
                            if(this.fruits2[k]){
                                if(this.fruits[k].collidesWith(this.lagartas[i])){
                                    if(this.fruits2[this.currentTarget - 5]){
                        ...
                        for(let l = 0; l < this.fruits3.length; l++){
                            if(this.fruits3[l]){
                                if(this.fruits3[l].collidesWith(this.lagartas[i])){
                                    if(this.fruits3[this.currentTarget - 5]){
                                        this.fruits3[this.currentTarget - 5].draggedRight = false;
                                    }
                                    this.protectFruit = true;
                        ...
                        if(this.currentTarget > 4 && this.currentTarget < 9){ {
                            for(let j = 0; j < this.fruits2.length; j++){
                                if(this.fruits2[j]){
                                    if(this.fruits2[j].collidesWith(this.lagartas[i])){
                                        if(this.fruits2[this.currentTarget - 5]){
                                            this.fruits2[this.currentTarget - 5].draggedRight = false;
                                        }
                                        this.protectFruit = true;
                        ...
                        if(this.currentTarget > 9){ {
                            for(let j = 0; j < this.fruits3.length; j++){
                                if(this.fruits3[j]){
                                    if(this.fruits3[j].collidesWith(this.lagartas[i])){
                                        if(this.fruits3[this.currentTarget - 10]){
                                            this.fruits3[this.currentTarget - 10].draggedRight = false;
                                        }
                                        this.protectFruit = true;
            ...
            (()=>{
                ...
                for(let i = 0; i < this.fruits2.length; i++){
                    if(this.fruits2[i].isMouseClicking() && !this.game.isDraggingImage || this.fruits2[i].isTouchOver() && !this.game.isDraggingImage){
                        this.fruits2[i].draggedRight = false;
                    }
                }

                for(let i = 0; i < this.fruits3.length; i++){
                    if(this.fruits3[i].isMouseClicking() && !this.game.isDraggingImage || this.fruits3[i].isTouchOver() && !this.game.isDraggingImage){
                        this.fruits3[i].draggedRight = false;
                    }
                }
            })();
            ...
            (()=>{
                if(this.confirmButton.isTouchOver() || this.confirmButton.isMouseClicking()){
                    if(this.startGame && this.keyboard.currentInput.length > 0){
                        ...
                        console.log(this.fruitsInBasket.length);
                        console.log(this.fruitsToDrag + this.fruitsToDrag2);

                        if(this.fruitsInBasket.length === parseInt(this.keyboard.currentInput) && this.fruitsInBasket.length === (this.fruitsToDrag + this.fruitsToDrag2 + this.fruitsToDrag3)){
                            ...
                            let fruits3InBasket = this.fruitsInBasket.filter(fruit => fruit.tags.includes("FRUIT_3")).length;

                            console.log(this.fruitsInBasket);
                            //console.log(fruits2InBasket);

                            if(fruits1InBasket === this.fruitsToDrag && fruits2InBasket === this.fruitsToDrag2 && fruits3InBasket === this.fruitsToDrag3){
            ...
            (() => {
                if (this.restartButton.isTouchOver() || this.restartButton.isMouseClicking()) {
                    ...
                    for (let i = 0; i < this.fruits2.length; i++) {
                        this.fruits2[i].dropped = false;
                        this.fruits2[i].draggedRight = false;
                    }
                    for (let i = 0; i < this.fruits3.length; i++) {
                        this.fruits3[i].dropped = false;
                        this.fruits3[i].draggedRight = false;
                    }
                    this.correctAnswer = false;
                    this.wrongAnswer = false;
        ...
        (() => {
            ...
            (()=>{
                for(let i = 0; i < this.lagartas.length; i++){
                    if(this.startGame && !this.correctAnswer && !this.wrongAnswer){
                        this.lagartas[i].update(deltaTime);
                    }
                };
            })();
            ...
            (()=>{
                if(this.startGame && !this.fruitsStolen && !this.correctAnswer && !this.wrongAnswer){
                    for(let i = 0; i < this.fruits2.length; i++){
                        this.fruits2[i].update(deltaTime);
                        this.fruits2[i].draggable = true;
                    }
                } else {
                    for(let i = 0; i < this.fruits2.length; i++){
                        this.fruits2[i].draggable = false;
                    }
                }
            })();
            ...
            (()=>{
                if(this.startGame && !this.fruitsStolen && !this.correctAnswer && !this.wrongAnswer){
                    for(let i = 0; i < this.fruits3.length; i++){
                        this.fruits3[i].update(deltaTime);
                        this.fruits3[i].draggable = true;
                    }
                } else {
                    for(let i = 0; i < this.fruits3.length; i++){
                        this.fruits3[i].draggable = false;
                    }
                }
            })();
            ...
            (()=>{
                for(let i = 0; i < this.tomatoes.length; i++){
                    this.tomatoes[i].update(deltaTime);
                };
            })();
        ...
        (() => {
            ...
            if (this.startGame) {
                ...
                for (let i = 0; i < this.fruits2.length; i++) {
                    ...
                    if (this.fruits2[i].collidesWith(this.basket) && this.fruits2[i].dropped && !this.wrongAnswer && !this.restart) {
                        // Verifica se a fruta já está no array fruitsInBasket
                        const isFruitAlreadyInBasket = this.fruitsInBasket.some(fruitInBasket => fruitInBasket === this.fruits2[i]);
                        if (!isFruitAlreadyInBasket) {
                            this.fruits2[i].draggedRight = true;
                            this.fruitsInBasket.push(this.fruits2[i]);
                        }
                        // Marca a fruta como não soltável novamente para evitar duplicatas
                        this.fruits2[i].dropped = false;
                ...
                for (let i = 0; i < this.fruits3.length; i++) {
                    ...
                    if (this.fruits3[i].collidesWith(this.basket) && this.fruits3[i].dropped && !this.wrongAnswer && !this.restart) {
                        // Verifica se a fruta está no array fruitsInBasket
                        const isFruitAlreadyInBasket = this.fruitsInBasket.some(fruitInBasket => fruitInBasket === this.fruits3[i]);
                        if (!isFruitAlreadyInBasket) {
                            this.fruits3[i].draggedRight = true;
                            this.fruitsInBasket.push(this.fruits3[i]);
                        }
                        // Marca a fruta como não soltável novamente para evitar duplicatas
                        this.fruits3[i].dropped = false;
    ...
    draw(ctx, scene) {
        ...
        (()=>{
            ...
            //CONTINUAR AQUI, DESENHAR A lagarta NO LAYER CORRETO, QUANDO NO CURRENTARGET QUE É
            //FRUIT1 FICAR NO LAYER NA FRENTE DO this.fruits2, E QUANDO FORCURRENTARGET FRUIT2 DESENHAR
            //NO LAYER ATRÁS DO this.fruits2
            ...
            if(this.currentTarget !== 0 || this.currentTarget !== 1 || this.currentTarget !== 2 || this.currentTarget !== 3 || this.currentTarget !== 4){
                ...
                (()=>{
                    for(let i = 0; i < this.lagartas.length; i++){
                        if(this.startGame
                            //this.lagartas[i].x > (this.game.width * 0.5) ||
                            //this.lagartas[i].x < (this.game.width * 0.1)
                            )
                            {
                             this.lagartas[i].draw(ctx, 0);
                         }
                    }
            ...
            /** FRUITS 2 */
            for(let i = 0; i < this.fruits2.length; i++){
                if(this.fruits2[i].x < (this.game.width * 0.8)){
                    if(!this.fruits2[i].tags.includes('TOMATEIRO')){
                        this.fruits2[i].draw(ctx, 0);
                    } else {
        ...
        this.basket.draw(ctx, 0);
            ...
            /** FRUITS 2 */
            for(let i = 0; i < this.fruits2.length; i++){
                if(this.fruits2[i].x > (this.game.width * 0.6)){
                    if(!this.fruits2[i].tags.includes('TOMATEIRO')){
                        this.fruits2[i].draw(ctx, 0);
                    } else {
            ...
            /** FRUITS 3 */
            for(let i = 0; i < this.fruits3.length; i++){
                if(this.fruits3[i].x > (this.game.width * 0.6)){
                    this.fruits3[i].draw(ctx, 0);
                }
            }
    ...
    changeScene() {
        ...
        if(this.game.currentStage === 2){
            this.game.stagesDone.push("FLOWERS");
        } else {
        ...
        if(this.game.stagesDone.includes("FLOWERS")){
            ...
            this.game.changeScene(scene11);
        }
    }

    createVegetable(fruit, x, y, tagss){
        ...
        if(fruit === this.tomateiro){
            currentHeight = this.game.height * 0.25;
    ...
    createVegetable2(fruit, x, y, tagss){
    ...
    createVegetable3(fruit, x, y, tagss){
