...
export class Scene4 {
    ...
    constructor(game) {
        ...
        (()=>{
            ...
            while(this.randomFruit2 === this.randomFruit){
                this.randomFruit2 = Math.floor(Math.random() * 6);
            };
            ...
            (()=>{
                ...
                this.fruitsLocations = [
                    {x: this.game.width * 0.10, y: this.game.height * 0.09},
                    {x: this.game.width * 0.15, y: this.game.height * 0.16},
                    {x: this.game.width * 0.08, y: this.game.height * 0.2},
                    {x: this.game.width * 0.09, y: this.game.height * 0.45},
                    {x: this.game.width * 0.14, y: this.game.height * 0.31},
                    {x: this.game.width * 0.21, y: this.game.height * 0.35},
                ...
                this.fruitsToDrag2 = Math.floor(Math.random() * 9) + 1;

                
                while(this.fruitsToDrag === this.fruitsToDrag2 || this.fruitsToDrag + this.fruitsToDrag2 > 9){
                   this.fruitsToDrag = Math.floor(Math.random() * 9) + 1;
                    this.fruitsToDrag2 = Math.floor(Math.random() * 9) + 1;
                };
                ...
                this.choosedFruit2 = Math.floor(Math.random() * 6);
            ...
            (()=>{
                ...
                (()=>{
                    ...
                    this.fruitIndicator = new Image(
                        this.game, /**GAME */
                        (this.game.width * 0.245), /**X */
                        (this.height * 0.71), /**Y */
                        (this.game.width * 0.44), /**WIDTH */
