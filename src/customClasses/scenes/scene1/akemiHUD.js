...
export class AkemiHUD extends Hud {
    constructor(game, x, y, width, height, images) {
        ...
        this.imageLogo = new Image(this.game, 0, -this.game.height * 0.2, this.game.width * 0.3, this.game.height * 0.1, 0, this.images[0], 1);
        ...
        this.buttonStart = new Image(this.game, (this.width * 0.6), (this.height * 2.5), (this.width * 0.2), (this.game.height * 0.30), 0, this.images[3], 1, "INICIAR", "PatrickHand", "bold", 7, 1.08, 1.16, "black", true);
