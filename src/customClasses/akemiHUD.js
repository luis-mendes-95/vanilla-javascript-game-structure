...
export class AkemiHUD extends Hud {
    constructor(game, x, y, width, height, images) {
        ...
        this.imageAkemi = new Image(this.game, (this.width * 0.08), (this.height * 0.25), this.game.width * 0.34, this.game.height * 0.8, this.images[1], 0);
        ...
        this.cloud5 = new Image(this.game, (this.width * 0.5), (this.height * 0.05), (this.width * 0.06), (this.game.height * 0.06), this.images[5], 0.4);
    }
